    ...
    <table border="1">
        ...
        <?php if (!empty($broodjes)): ?>
            <?php foreach ($broodjes as $broodje): ?>
                <tr>
                    <td><?php echo htmlspecialchars($broodje['ID']); ?></td>
                    <td><?php echo htmlspecialchars($broodje['Naam']); ?></td>
                    <td><?php echo htmlspecialchars($broodje['Omschrijving']); ?></td>
                    <td><?php echo htmlspecialchars($broodje['Prijs']); ?></td>
                </tr>
            <?php endforeach; ?>
        <?php else: ?>
            <tr>
